...
public class ShieldbladeItem extends FabricShieldItem implements Vanishable {
    private final ToolMaterial material;
    private final float attackDamage;
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public ShieldbladeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
        super(settings, 100, material);
