...
public enum ModArmorMaterials implements ArmorMaterial {
    STEEL("steel", 20, new int[]{2, 5, 6, 2}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.5F, 0.0F, () -> Ingredient.ofItems(ModItems.STEEL_INGOT)),
    SILVER("silver", 26, new int[]{3, 5, 7, 3}, 18, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 1.0F, 0.0F, () -> Ingredient.ofItems(ModItems.SILVER_INGOT));
